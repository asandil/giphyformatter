...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_testd8_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_testd8_dd.inc';
}
// </DDSETTINGS>
$databases['default']['default'] = array (
  'database' => 'testd8',
...
$settings['hash_salt'] = 'tLdu5DhDBFvJHaL_y80UD4n405FBiQQxAQnN3SlSqdl37s8JeddMsdN3Zs4hRZQSZWfUvoLgUw';
